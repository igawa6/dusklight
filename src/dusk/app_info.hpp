...
namespace dusk {
     ...
     *
     * githubOwner/githubRepo are deliberately separate from orgName: that one
     * is a file-path identity and must not change, while these track
     * whichever fork ships the build (the startup update check queries them).
     */
